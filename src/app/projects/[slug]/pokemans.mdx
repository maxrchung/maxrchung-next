...
When I first published this game on my website almost a year ago, I built an exe for the client, but not the server. The idea was to run the POKEMANS server along with the server hosting my website. We were planning on making a few additional changes to make everything stable, but that never really panned out. So on that end, I've just made the download include all the source files. To run, make you are using/have Python 2.7 and Pygame 1.9.1. You will need to edit the TCP\_IP value within NetworkManager.py to connect to a specific server.
...
<video autoplay loop controls><source src="https://maxrchung-rails.s3.amazonaws.com/uploads/cat_wire.webm"/></video>
...
<img src="https://maxrchung-rails.s3.amazonaws.com/uploads/pokemans_battle_menu.jpg" /><p className="caption">Original gangster</p>
...
<video autoplay loop controls><source src="https://maxrchung-rails.s3.amazonaws.com/uploads/disappearing_truck.webm"/></video>
