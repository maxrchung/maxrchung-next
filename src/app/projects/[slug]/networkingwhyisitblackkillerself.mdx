...
networking\_why is it black-killer-self was a 2nd person shooter a few friends and I attempted to make during a game jam I hosted. For one reason or another, the project completely collapsed in on itself and our end product was nothing close to what we set out to achieve. Basically though, choosing to use Unreal was our first and last mistake.

*   Made with: Unreal Engine 4
*   Made by: Max Chung, Alex Lewis, Nina Volkmuth, Joshua Lin, Winston Liang, Emerson Sridhar
*   Download: [networking\_why is it black-killer-self.zip](https://s3.amazonaws.com/lolmypics/networking_why+is+it+black-killer-self.zip) (503.4 MB)
...
<img src="https://maxrchung-rails.s3.amazonaws.com/uploads/my_singing_monsters.jpg" /><p className="caption">Welp, apparently it looks like someone's on the right track</p>
...
<iframe width="960" height="720" src="https://www.youtube.com/embed/-vKm2rGFe3w" frameborder="0" allowfullscreen=""></iframe>
...
<video autoplay loop controls><source src="https://maxrchung-rails.s3.amazonaws.com/uploads/vr_roller_coaster.webm"/></video>
...
<video autoplay loop controls><source src="https://maxrchung-rails.s3.amazonaws.com/uploads/fallout_kill_yourself.webm"/></video>
...
<iframe width="960" height="720" src="https://www.youtube.com/embed/UmPmpUTr22c" frameborder="0" allowfullscreen=""></iframe>
...
<video autoplay loop controls><source src="https://maxrchung-rails.s3.amazonaws.com/uploads/men_vs_roadblock.webm"/></video>
...
<video controls><source src="https://maxrchung-rails.s3.amazonaws.com/uploads/why_is_it_black.mp4"/></video>
...
The name was born from that deep, burning hatred. Maybe from now on all of our game projects will have ridiculous titles, following [Quaternion: Too Drunk 4 a Title (Basically a Tuple)](http://maxrchung.com/projects/quaterniontoodrunk4atitlebasicallyatuple)'s example. Honestly, I'm not too adverse to that. Thinking up names is always difficult. While having a stupid title like networking\_why is it black-killer-self is indeed pretty stupid, it's something all its developers remember it by. In the end, the game is made half just for us anyways.
