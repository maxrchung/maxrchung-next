...
import TheBoyGallery from "@/components/Main/TheBoyGallery/TheBoyGallery";
...
better sounding, I'm going to create some kind of gallery-like component later
on in the post. Might as well take advantage of React now that I've upgraded my
[site update](https://maxrchung.com/projects/maxrchungnext). Also might as well
do this since I'm kind of laid off right now and should probably do some
frontend exercises. 🤪
...
reason why I haven't touched these for like the past 3 or 4 years or something.
I'm going to try something a little different and try some kind of interesting
gallery component format.
