...
As for my idea sucking yeah I kind of deployed it and never
used it once lol. So much more actually tracking things. You used to be able to
access it at [https://tracker.maxrchung.com](https://tracker.maxrchung.com) but
I recently ran into a problem with Google OAuth, don't really want to fix it,
don't use the site, so I'm just going to undeploy it and save a few cents.
