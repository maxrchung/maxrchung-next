<img src="https://maxrchung-rails.s3.amazonaws.com/uploads/C0.png" />
...
*   Download (Java): [ks.jar](https://maxrchung-rails.s3.amazonaws.com/uploads/ks.jar) (3.5 MB)
...
<img src="https://maxrchung-rails.s3.amazonaws.com/uploads/example.png" /><p className="caption">An example screenshot from Katawa Shoujo of a visual novel</p>
...
<img src="https://maxrchung-rails.s3.amazonaws.com/uploads/katanaShoujo.jpg" /><p className="caption">Katana Shoujo, clearly among my finest creations</p><img src="https://maxrchung-rails.s3.amazonaws.com/uploads/katawaShoujo.jpg" /><p className="caption">Original</p>
...
<img src="https://maxrchung-rails.s3.amazonaws.com/uploads/onePiece.jpg" /><p className="caption">Much fun and some Photoshops were had</p>
...
<img src="https://maxrchung-rails.s3.amazonaws.com/uploads/katanagrill.png" />
...
<img src="https://maxrchung-rails.s3.amazonaws.com/uploads/character.png" /><p className="caption">This is why all our characters and the Katana Shoujo icon are white squares</p>
...
<img src="https://maxrchung-rails.s3.amazonaws.com/uploads/classroomLines.png" /><p className="caption">Classroom lines</p>
...
<img src="https://maxrchung-rails.s3.amazonaws.com/uploads/classroomGrids.png" /><p className="caption">Rule of thirds indicated on the classroom background</p><img src="https://maxrchung-rails.s3.amazonaws.com/uploads/classroomGridsFlipped.png" /><p className="caption">Rule of thirds indicated on the flipped classroom background</p>
...
<img src="https://maxrchung-rails.s3.amazonaws.com/uploads/classroom.png" /><p className="caption">Classroom</p><img src="https://maxrchung-rails.s3.amazonaws.com/uploads/schoolHallwayLines.png" /> <img src="https://maxrchung-rails.s3.amazonaws.com/uploads/schoolHallway.png" /><p className="caption">School hallway</p><img src="https://maxrchung-rails.s3.amazonaws.com/uploads/dormHallwayLines.png" /> <img src="https://maxrchung-rails.s3.amazonaws.com/uploads/dormHallway.png" /><p className="caption">Whew that wonky perspective</p><p className="caption">Dorm hallway</p><img src="https://maxrchung-rails.s3.amazonaws.com/uploads/bedroomLines.png" /> <img src="https://maxrchung-rails.s3.amazonaws.com/uploads/bedroom.png" /><p className="caption">Bedroom</p><img src="https://maxrchung-rails.s3.amazonaws.com/uploads/parkLines.png" /> <img src="https://maxrchung-rails.s3.amazonaws.com/uploads/park.png" /><p className="caption">Park</p><img src="https://maxrchung-rails.s3.amazonaws.com/uploads/cafeteriaLines.png" /> <img src="https://maxrchung-rails.s3.amazonaws.com/uploads/cafeteria.png" /><p className="caption">Cafeteria</p>
...
<img src="https://maxrchung-rails.s3.amazonaws.com/uploads/sounds.png" /><p className="caption">The sounds do indeed exist</p>
...
<img src="https://maxrchung-rails.s3.amazonaws.com/uploads/introduction.png" /><p className="caption">Here is a snippet of our text docs and the format we used</p>
...
<img src="https://maxrchung-rails.s3.amazonaws.com/uploads/doubleBuffering.png" /><p className="caption">Double buffering code</p>
...
<img src="https://maxrchung-rails.s3.amazonaws.com/uploads/christina.png" /><p className="caption">Yep, that's her</p>
...
<img src="https://maxrchung-rails.s3.amazonaws.com/uploads/plugdj.png" />
